...
export function HeroSection(): React.ReactElement {
  ...
  return (
    <section className="hero-spectacle relative overflow-hidden pb-16 pt-6 sm:pb-20 sm:pt-10">
      ...
      <div className="max-w-container-max relative mx-auto px-5 md:px-8">
        <motion.div
          ...
          className="shadow-apple mx-auto flex max-w-fit items-center gap-2 rounded-full border-[0.5px] border-[var(--separator)] bg-[var(--bg-elevated)] px-4 py-1.5"
        >
        ...
        <div className="mt-10 text-center">
          ...
          >
            <Link
              href="/register"
              className="apple-btn apple-btn-primary min-w-[11rem] px-8 py-3.5 text-base shadow-lg shadow-[color-mix(in_srgb,var(--accent)_25%,transparent)]"
            >
              {t("startDeploying")}
            </Link>
            <a
              href="#pricing"
              className="apple-btn apple-btn-ghost min-w-[11rem] px-8 py-3.5 text-base"
            >
              {t("viewDocs")}
            </a>
          </motion.div>
          ...
          >
            {trustItems.map((item, index) => (
              <li
                key={index}
                className="flex items-center gap-1.5 text-sm text-[var(--label-secondary)]"
              >
      ...
      <motion.a
        ...
        className="relative z-10 mx-auto mt-8 flex w-fit flex-col items-center gap-1 text-xs text-[var(--label-tertiary)]"
      >
