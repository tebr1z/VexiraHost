...
function catalogSection(
  ...
  const content: Record<string, unknown> = {
    ...
    emptyProducts: l(
      "Bu kategoride henüz ürün yok. Admin panelden ekleyin.",
      "No products in this category yet. Add them in admin.",
      "В этой категории пока нет товаров. Добавьте в админке.",
      "Bu kateqoriyada hələ məhsul yoxdur. Admin paneldən əlavə edin.",
    ),
  };
    ...
    [
      ...
      },
      {
        ...
        content: {
          ...
          subtitle: l(
            "Admin panelden bu kategoriye ürün ekleyin; burada otomatik listelenir.",
            "Add products to this category in admin — they appear here automatically.",
            "Добавляйте товары в категорию в админке — они появятся здесь.",
            "Admin paneldən bu kateqoriyaya məhsul əlavə edin — burada avtomatik görünəcək.",
          ),
          guarantees: [
            l("Orijinal lisans", "Genuine license", "Оригинальная лицензия", "Orijinal lisenziya"),
            l("Hızlı aktivasyon", "Fast activation", "Быстрая активация", "Sürətli aktivasiya"),
          ...
          emptyProducts: l(
            "Henüz lisans ürünü yok. Admin → Ürünler’den License kategorisine ekleyin.",
            "No license products yet. Add them under License category in Admin → Products.",
            "Лицензий пока нет. Добавьте в категории License в Admin → Products.",
            "Hələ lisenziya məhsulu yoxdur. Admin → Məhsullardan License kateqoriyasına əlavə edin.",
          ),
        },
      },
      {
        ...
        content: {
          ...
          items: [
            ...
            },
            {
              ...
              answer: l(
                "Admin panelde Ürünler → Yeni ürün, kategori olarak License seçin. Bu sayfada otomatik görünür.",
                "In Admin → Products → New product, set category to License. It appears on this page automatically.",
                "В Admin → Products создайте товар с категорией License — он появится на этой странице.",
                "Admin → Məhsullar → Yeni məhsul, kateqoriya olaraq License seçin. Bu səhifədə avtomatik görünəcək.",
              ),
            },
          ],
        },
    ...
    [
      ...
      },
      {
        ...
        content: {
          ...
          emptyProducts: l(
            "Henüz e-posta ürünü yok. Admin → Ürünler’den Email kategorisine ekleyin.",
            "No email products yet. Add them under Email category in Admin → Products.",
            "Почтовых продуктов пока нет. Добавьте в категории Email.",
            "Hələ e-poçt məhsulu yoxdur. Admin → Məhsullardan Email kateqoriyasına əlavə edin.",
          ),
        },
      },
      {
    ...
    [
      ...
      },
      {
        ...
        content: {
          ...
          subtitle: l(
            "Admin panelden yeni Windows lisans sayfası ekleyebilirsiniz.",
            "Add new Windows license pages from the admin panel.",
            "Добавляйте новые страницы лицензий Windows в админке.",
            "Admin paneldən yeni Windows lisenziya səhifəsi əlavə edə bilərsiniz.",
          ),
          emptyMessage: l(
            "Henüz Windows lisans sayfası yok. Admin → Sayfa İçerikleri bölümünden ekleyin.",
            "No Windows license pages yet. Add them in Admin → Page Content.",
            "Страниц лицензий Windows пока нет. Добавьте в Admin → Page Content.",
            "Hələ Windows lisenziya səhifəsi yoxdur. Admin → Səhifə Məzmunu bölməsindən əlavə edin.",
          ),
        },
      },
    ],
  ...
  await seedCmsPageIfMissing(prisma, "vps", l("VDS / VPS", "VDS / VPS", "VDS / VPS", "VDS / VPS"), [
    ...
    },
    {
      ...
      content: {
        ...
        subtitle: l(
          "Admin panelden VPS kategorisine ürün ekleyin; bu sayfada listelenir.",
          "Add products under the VPS category in admin — they list on this page.",
          "Добавляйте товары в категорию VPS — они появятся здесь.",
          "Admin paneldən VPS kateqoriyasına məhsul əlavə edin — burada görünəcək.",
        ),
        guarantees: [
        ...
        emptyProducts: l(
          "Henüz VPS ürünü yok. Admin → Ürünler’den VPS kategorisine ekleyin.",
          "No VPS products yet. Add them under VPS category in Admin → Products.",
          "VPS-товаров пока нет. Добавьте в категории VPS.",
          "Hələ VPS məhsulu yoxdur. Admin → Məhsullardan VPS kateqoriyasına əlavə edin.",
        ),
      },
    },
    {
